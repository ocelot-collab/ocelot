...
class Wake():
    ...
    def s2current(self, P0, q, Ns, NF, v):
        """
        I=s2current(P0,q,Ns,NF)
        :param P0: s-vector
        :param q: charge-vector
        :param Ns: number of sampling points
        :param NF: filter order
    ...
    def add_total_wake(self, X, Y, Z, q, TH, Ns, NF):
        ...
        I00 = self.s2current(Z,q,Ns,NF,c)
        Nw=I00.shape[0]
    ...
    def apply(self, p_array, dz):
        ...
        Px, Py, Pz, I00 = self.add_total_wake(ps[0::6], ps[2::6], ps[4::6], p_array.q_array, self.TH, self.w_sampling, self.filter_order)
