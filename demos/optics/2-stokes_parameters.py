...
#%%
plot_stokes_values(S[51, np.newaxis, 51, np.newaxis, :], direction='x', fig=plt.figure('Stokes_x_vals'))
plot_stokes_angles(S[51, np.newaxis, 51, np.newaxis, :], direction='x', fig=plt.figure('Stokes_x_ang'))
#%%
plot_stokes_values(S[:, 51, np.newaxis, 51, np.newaxis], direction='z', fig=plt.figure('Stokes_z_vals'))
plot_stokes_angles(S[:, 51, np.newaxis, 51, np.newaxis], direction='z', fig=plt.figure('Stokes_z_ang'))
#%%
