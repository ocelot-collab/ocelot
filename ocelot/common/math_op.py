...
def mprefix(value, order_bias=1/3):
    '''
    estimate metric prefix for a scalar or np.array
    accepts floating point number
    order_bias is numbetr of order of magnitudes to round up to. Allows to avoid values like 995 instead of 0.995k. 1/3 corresponds to ...980,990,0.10,0.11...
    returns scaled values (float or numpy arrayof floats) and its prefix (string)
        '''
    prefix_range = (-30, 30)
    prefixes = {-30:'q', -27:'r', -24:'y', -21:'z', -18:'a', -15:'f', -12:'p', -9:'n', -6:'u', -3:'m', 0:'', 3:'k', 6:'M', 9:"G", 12:'T', 15:'P', 18:'E', 21:'Z', 24:'Y', 27:'R', 30:'Q'}
