...
def t_nnn_mad(L, h, k1, k2, energy=0):
    ...
    L4 = L3*L
    L5 = L4*L
    #dx_h = h/kx2*(1. - cx) if kx != 0. else L*L*h/2.
    ...
    #print("CHECK2", L, beta, K1, (np.sin(ky*L)/ky).real, sy, T336)
    ...
    T[1-1, 1-1, 1-1] = T111
    T[1-1, 1-1, 2-1] = T112*2
    T[1-1, 2-1, 2-1] = T122
    T[1-1, 1-1, 6-1] = T116*2
    T[1-1, 2-1, 6-1] = T126*2
    T[1-1, 6-1, 6-1] = T166
    T[1-1, 3-1, 3-1] = T133
    T[1-1, 3-1, 4-1] = T134*2
    T[1-1, 4-1, 4-1] = T144

    T[2-1, 1-1, 1-1] = T211
    T[2-1, 1-1, 2-1] = T212*2
    T[2-1, 2-1, 2-1] = T222
    T[2-1, 1-1, 6-1] = T216*2
    T[2-1, 2-1, 6-1] = T226*2
    T[2-1, 6-1, 6-1] = T266
    T[2-1, 3-1, 3-1] = T233
    T[2-1, 3-1, 4-1] = T234*2
    T[2-1, 4-1, 4-1] = T244

    T[3-1, 1-1, 3-1] = T313*2
    T[3-1, 1-1, 4-1] = T314*2
    T[3-1, 2-1, 3-1] = T323*2
    T[3-1, 2-1, 4-1] = T324*2
    T[3-1, 3-1, 6-1] = T336*2
    T[3-1, 4-1, 6-1] = T346*2


    T[4-1, 1-1, 3-1] = T413*2
    T[4-1, 1-1, 4-1] = T414*2
    T[4-1, 2-1, 3-1] = T423*2
    T[4-1, 2-1, 4-1] = T424*2
    T[4-1, 3-1, 6-1] = T436*2
    T[4-1, 4-1, 6-1] = T446*2

    T[5-1, 1-1, 1-1] = -T511
    T[5-1, 1-1, 2-1] = -T512*2
    T[5-1, 2-1, 2-1] = -T522
    T[5-1, 1-1, 6-1] = -T516*2
    T[5-1, 2-1, 6-1] = -T526*2
    T[5-1, 6-1, 6-1] = -T566
    T[5-1, 3-1, 3-1] = -T533
    T[5-1, 3-1, 4-1] = -T534*2
    T[5-1, 4-1, 4-1] = -T544
    return T
