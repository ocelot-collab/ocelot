...
class DrawElements():
    ...
    def __init__(self, MainWindow, add_tune_block_func, elements_popup):
        self.mw = MainWindow
        self.add_tune_block = add_tune_block_func
        self.elements_popup = elements_popup
        self.scale = 0.2
    ...
    def draw_lattice_elements(self, lattice):
        ...
        for elem_class in elements:
            ...
            for elem in elements[elem_class]:
                ...
                item.elements_popup = self.elements_popup
...
class callbackElement(QtGui.QGraphicsRectItem):
    ...
    def hoverEnterEvent(self, event):
        ...
        if self.element.__class__.__name__ in self.elements_popup:
