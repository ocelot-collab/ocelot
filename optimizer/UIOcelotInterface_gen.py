...
#
# Created: Wed Jan 18 12:19:55 2017
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.sb_ddelay.setSingleStep(0.1)
        ...
        self.le_obj_fun = QtGui.QLineEdit(self.groupBox_3)
        self.le_obj_fun.setEnabled(False)
        font = QtGui.QFont()
        font.setPointSize(18)
        self.le_obj_fun.setFont(font)
        self.le_obj_fun.setObjectName(_fromUtf8("le_obj_fun"))
        self.verticalLayout_5.addWidget(self.le_obj_fun)
        self.cb_select_alg_old = QtGui.QComboBox(self.groupBox_3)
        self.cb_select_alg_old.setEnabled(False)
        self.cb_select_alg_old.setMinimumSize(QtCore.QSize(0, 0))
        self.cb_select_alg_old.setMaximumSize(QtCore.QSize(16777215, 16777215))
        font = QtGui.QFont()
        font.setPointSize(18)
        self.cb_select_alg_old.setFont(font)
        self.cb_select_alg_old.setObjectName(_fromUtf8("cb_select_alg_old"))
        self.verticalLayout_5.addWidget(self.cb_select_alg_old)
        ...
        self.gridLayout_11.addWidget(self.cb_use_predef, 4, 0, 1, 1)
        ...
        self.gridLayout_11.addWidget(self.pb_edit_obj_func, 5, 0, 1, 2)
    ...
    def retranslateUi(self, Form):
        ...
        self.label_15.setText(_translate("Form", "Timeout ", None))
        ...
        self.label_24.setText(_translate("Form", "sec                                           ", None))
