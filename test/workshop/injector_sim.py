...
# drifts 
D_1 = Drift(l = 3.5212, eid = 'D_1')
start_sim = Marker()
D_1 = (Drift(l=3.2), start_sim, Drift(l=3.5212-3.2))
D_2 = Drift(l = 0.3459, eid = 'D_2')
D_3 = Drift(l = 0.3459, eid = 'D_3')
D_4 = Drift(l = 0.3459, eid = 'D_4')
D_5 = Drift(l = 0.3459, eid = 'D_5')
D_6 = Drift(l = 0.3459, eid = 'D_6')
D_7 = Drift(l = 0.3459, eid = 'D_7')
D_8 = Drift(l = 0.3459, eid = 'D_8')
D_9 = Drift(l = 0.2043, eid = 'D_9')
D_10 = Drift(l = 0.849, eid = 'D_10')
D_11 = Drift(l = 0.202, eid = 'D_11')
D_12 = Drift(l = 0.262, eid = 'D_12')
D_13 = Drift(l = 0.262, eid = 'D_13')
D_14 = Drift(l = 0.262, eid = 'D_14')
D_15 = Drift(l = 0.262, eid = 'D_15')
D_16 = Drift(l = 0.262, eid = 'D_16')
D_17 = Drift(l = 0.262, eid = 'D_17')
D_18 = Drift(l = 0.262, eid = 'D_18')
D_19 = Drift(l = 2.8433, eid = 'D_19')
D_20 = Drift(l = 0.6785, eid = 'D_20')
D_21 = Drift(l = 0.1509998582, eid = 'D_21')
D_22 = Drift(l = 0.1004967165, eid = 'D_22')
D_23 = Drift(l = 0.6539998582, eid = 'D_23')
D_24 = Drift(l = 0.3139998582, eid = 'D_24')
D_25 = Drift(l = 0.1004977165, eid = 'D_25')
D_26 = Drift(l = 0.1509998582, eid = 'D_26')
D_27 = Drift(l = 1.31149, eid = 'D_27')
D_28 = Drift(l = 0.07, eid = 'D_28')
D_29 = Drift(l = 0.07, eid = 'D_29')
D_30 = Drift(l = 0.752, eid = 'D_30')
D_31 = Drift(l = 1.35, eid = 'D_31')
D_32 = Drift(l = 1.35, eid = 'D_32')
D_33 = Drift(l = 1.35, eid = 'D_33')
D_34 = Drift(l = 0.9, eid = 'D_34')
D_35 = Drift(l = 1.05, eid = 'D_35')
D_36 = Drift(l = 1.99, eid = 'D_36')
D_37 = Drift(l = 2.35, eid = 'D_37')
D_38 = Drift(l = 2.9, eid = 'D_38')
D_39 = Drift(l = 1.8, eid = 'D_39')
D_40 = Drift(l = 0.9, eid = 'D_40')
D_41 = Drift(l = 0.7, eid = 'D_41')
D_42 = Drift(l = 0.2012266681, eid = 'D_42')
D_43 = Drift(l = 0.4804816681, eid = 'D_43')
D_44 = Drift(l = 0.1, eid = 'D_44')
D_45 = Drift(l = 0.1, eid = 'D_45')
D_46 = Drift(l = 0.1409824195, eid = 'D_46')
D_47 = Drift(l = 0.5086084195, eid = 'D_47')
D_48 = Drift(l = 0.5086074195, eid = 'D_48')
D_49 = Drift(l = 0.1409824195, eid = 'D_49')
D_50 = Drift(l = 0.1, eid = 'D_50')
D_51 = Drift(l = 0.1, eid = 'D_51')
D_52 = Drift(l = 0.4804816681, eid = 'D_52')
D_53 = Drift(l = 0.2012266681, eid = 'D_53')
D_54 = Drift(l = 0.2012276681, eid = 'D_54')
D_55 = Drift(l = 0.4804816681, eid = 'D_55')
D_56 = Drift(l = 0.1, eid = 'D_56')
D_57 = Drift(l = 0.1, eid = 'D_57')
D_58 = Drift(l = 0.1409814195, eid = 'D_58')
D_59 = Drift(l = 0.5086084195, eid = 'D_59')
D_60 = Drift(l = 0.5086084195, eid = 'D_60')
D_61 = Drift(l = 0.1409824195, eid = 'D_61')
D_62 = Drift(l = 0.1, eid = 'D_62')
D_63 = Drift(l = 0.1, eid = 'D_63')
D_64 = Drift(l = 0.4804816681, eid = 'D_64')
D_65 = Drift(l = 0.2012266681, eid = 'D_65')
D_66 = Drift(l = 0.2012266681, eid = 'D_66')
D_67 = Drift(l = 0.4804816681, eid = 'D_67')
D_68 = Drift(l = 0.1, eid = 'D_68')
D_69 = Drift(l = 0.1, eid = 'D_69')
D_70 = Drift(l = 0.1409824195, eid = 'D_70')
D_71 = Drift(l = 0.5086084195, eid = 'D_71')
D_72 = Drift(l = 0.5086084195, eid = 'D_72')
D_73 = Drift(l = 0.1409814195, eid = 'D_73')
D_74 = Drift(l = 0.1, eid = 'D_74')
D_75 = Drift(l = 0.1, eid = 'D_75')
D_76 = Drift(l = 0.4804826681, eid = 'D_76')
D_77 = Drift(l = 0.2012266681, eid = 'D_77')
D_78 = Drift(l = 0.2012266681, eid = 'D_78')
D_79 = Drift(l = 0.4804816681, eid = 'D_79')
D_80 = Drift(l = 0.1, eid = 'D_80')
D_81 = Drift(l = 0.1, eid = 'D_81')
D_82 = Drift(l = 0.1409814195, eid = 'D_82')
D_83 = Drift(l = 0.5086084195, eid = 'D_83')
D_84 = Drift(l = 0.5086084195, eid = 'D_84')
D_85 = Drift(l = 0.1409824195, eid = 'D_85')
D_86 = Drift(l = 0.1, eid = 'D_86')
D_87 = Drift(l = 0.1, eid = 'D_87')
D_88 = Drift(l = 0.4804816681, eid = 'D_88')
D_89 = Drift(l = 0.2012266681, eid = 'D_89')
D_90 = Drift(l = 1.31013, eid = 'D_90')
D_91 = Drift(l = 0.81, eid = 'D_91')
D_92 = Drift(l = 0.5000004395, eid = 'D_92')
D_93 = Drift(l = 1.0088728791, eid = 'D_93')
D_94 = Drift(l = 1.5000008791, eid = 'D_94')
D_95 = Drift(l = 1.0088728791, eid = 'D_95')
D_96 = Drift(l = 0.5100004395, eid = 'D_96')
D_97 = Drift(l = 0.91, eid = 'D_97')
D_98 = Drift(l = 0.97, eid = 'D_98')
D_99 = Drift(l = 2.3, eid = 'D_99')
D_100 = Drift(l = 2.3, eid = 'D_100')
D_101 = Drift(l = 2.3, eid = 'D_101')
D_102 = Drift(l = 2.45, eid = 'D_102')
D_103 = Drift(l = 1.675, eid = 'D_103')
D_104 = Drift(l = 1.9, eid = 'D_104')
...
# undulator 
#UNDU_49_I1 = Undulator(lperiod = 0.0, nperiods = 0, Kx = 0.0, Ky = 0.0, eid = 'UNDU.49.I1')
...
# cavity 
C_A1_1_1_I1 = Cavity(l = 1.0377, v = 0.01815975, freq = 0.0, phi = 0.0, eid = 'C.A1.1.1.I1')
C_A1_1_2_I1 = Cavity(l = 1.0377, v = 0.01815975, freq = 0.0, phi = 0.0, eid = 'C.A1.1.2.I1')
C_A1_1_3_I1 = Cavity(l = 1.0377, v = 0.01815975, freq = 0.0, phi = 0.0, eid = 'C.A1.1.3.I1')
C_A1_1_4_I1 = Cavity(l = 1.0377, v = 0.01815975, freq = 0.0, phi = 0.0, eid = 'C.A1.1.4.I1')
C_A1_1_5_I1 = Cavity(l = 1.0377, v = 0.01815975, freq = 0.0, phi = 0.0, eid = 'C.A1.1.5.I1')
C_A1_1_6_I1 = Cavity(l = 1.0377, v = 0.01815975, freq = 0.0, phi = 0.0, eid = 'C.A1.1.6.I1')
C_A1_1_7_I1 = Cavity(l = 1.0377, v = 0.01815975, freq = 0.0, phi = 0.0, eid = 'C.A1.1.7.I1')
C_A1_1_8_I1 = Cavity(l = 1.0377, v = 0.01815975, freq = 0.0, phi = 0.0, eid = 'C.A1.1.8.I1')
C3_AH1_1_1_I1 = Cavity(l = 0.346, v = 0.0024999884, freq = 0.0, phi = 180.0, eid = 'C3.AH1.1.1.I1')
C3_AH1_1_2_I1 = Cavity(l = 0.346, v = 0.0024999884, freq = 0.0, phi = 180.0, eid = 'C3.AH1.1.2.I1')
C3_AH1_1_3_I1 = Cavity(l = 0.346, v = 0.0024999884, freq = 0.0, phi = 180.0, eid = 'C3.AH1.1.3.I1')
C3_AH1_1_4_I1 = Cavity(l = 0.346, v = 0.0024999884, freq = 0.0, phi = 180.0, eid = 'C3.AH1.1.4.I1')
C3_AH1_1_5_I1 = Cavity(l = 0.346, v = 0.0024999884, freq = 0.0, phi = 180.0, eid = 'C3.AH1.1.5.I1')
C3_AH1_1_6_I1 = Cavity(l = 0.346, v = 0.0024999884, freq = 0.0, phi = 180.0, eid = 'C3.AH1.1.6.I1')
C3_AH1_1_7_I1 = Cavity(l = 0.346, v = 0.0024999884, freq = 0.0, phi = 180.0, eid = 'C3.AH1.1.7.I1')
C3_AH1_1_8_I1 = Cavity(l = 0.346, v = 0.0024999884, freq = 0.0, phi = 180.0, eid = 'C3.AH1.1.8.I1')
...
# lattice 
cell = (D_1, C_A1_1_1_I1, D_2, C_A1_1_2_I1, D_3, C_A1_1_3_I1, D_4, 
C_A1_1_4_I1, D_5, C_A1_1_5_I1, D_6, C_A1_1_6_I1, D_7, C_A1_1_7_I1, D_8, 
C_A1_1_8_I1, D_9, Q_37_I1, D_10, Q_38_I1, D_11, C3_AH1_1_1_I1, D_12, 
C3_AH1_1_2_I1, D_13, C3_AH1_1_3_I1, D_14, C3_AH1_1_4_I1, D_15, C3_AH1_1_5_I1, D_16, 
C3_AH1_1_6_I1, D_17, C3_AH1_1_7_I1, D_18, C3_AH1_1_8_I1, D_19, QI_46_I1, D_20, 
QI_47_I1, D_21, BL_48I_I1, D_22, BL_48II_I1, D_23, UNDU_49_I1, D_24, 
BL_50I_I1, D_25, BL_50II_I1, D_26, QI_50_I1, D_27, QI_52_I1, D_28, 
TDSA_52_I1, D_29, QI_53_I1, D_30, QI_54_I1, D_31, QI_55_I1, D_32, 
QI_57_I1, D_33, QI_59_I1, D_34, QI_60_I1, D_35, QI_61_I1, D_36, 
QI_63_I1, D_37, QI_66_I1, D_38, QI_69_I1, D_39, QI_71_I1, D_40, 
QI_72_I1, D_41, QI_73_I1, D_42, BL_73_I1, D_43, SC_74I_I1, D_44, 
QI_74_I1, D_45, SC_74II_I1, D_46, BL_75_I1, D_47, QI_75_I1, D_48, 
BL_76_I1, D_49, SC_76_I1, D_50, QI_77_I1, D_51, SC_77_I1, D_52, 
BL_77_I1, D_53, QI_78_I1, D_54, BL_78_I1, D_55, SC_79I_I1, D_56, 
QI_79_I1, D_57, SC_79II_I1, D_58, BL_80_I1, D_59, QI_80_I1, D_60, 
BL_81_I1, D_61, SC_81_I1, D_62, QI_82_I1, D_63, SC_82_I1, D_64, 
BL_82_I1, D_65, QI_83_I1, D_66, BL_83_I1, D_67, SC_84I_I1, D_68, 
QI_84_I1, D_69, SC_84II_I1, D_70, BL_85_I1, D_71, QI_85_I1, D_72, 
BL_86_I1, D_73, SC_86_I1, D_74, QI_86_I1, D_75, SC_87_I1, D_76, 
BL_87_I1, D_77, QI_88_I1, D_78, BL_88_I1, D_79, SC_89I_I1, D_80, 
QI_89_I1, D_81, SC_89II_I1, D_82, BL_90_I1, D_83, QI_90_I1, D_84, 
BL_91_I1, D_85, SC_91_I1, D_86, QI_92_I1, D_87, SC_92_I1, D_88, 
BL_92_I1, D_89, QI_93_I1, D_90, QI_94_I1, D_91, QI_95_I1, D_92, 
BB_96_I1, D_93, BB_98_I1, D_94, BB_100_I1, D_95, BB_101_I1, D_96, 
QI_102_I1, D_97, QI_103_I1, D_98, QI_104_I1, D_99, QI_107_I1, D_100, 
QI_109_I1, D_101, QI_112_I1, D_102, QI_114_I1, D_103, QI_116_I1, D_104, 
QI_118_I1)