...
def lattice_inj(cell, method):
    ...
    # Cavitys
    dip_kick = 0
    c_a1_1_1_i1 = Cavity(l=1.0377, v=0.018125, freq=1300000000.0, vx_up=(-5.6813e-05 + 1.0751e-05j) * dip_kick,
                         vy_up=(-4.1091e-05 + 5.739e-07j) * dip_kick, vxx_up=(0.00099943 - 0.00081401j),
                         vxy_up=(0.0034065 - 0.0004146j), vx_down=(-2.4014e-05 + 1.2492e-05j) * dip_kick,
                         vy_down=(3.6481e-05 + 7.9888e-06j) * dip_kick, vxx_down=(-0.004057 - 0.0001369j),
                         vxy_down=(0.0029243 - 1.2891e-05j), eid='C.A1.1.1.I1')
    c_a1_1_2_i1 = Cavity(l=1.0377, v=0.018125, freq=1300000000.0, vx_up=(-5.6813e-05 + 1.0751e-05j) * dip_kick,
                         vy_up=(-4.1091e-05 + 5.739e-07j) * dip_kick, vxx_up=(0.00099943 - 0.00081401j),
                         vxy_up=(0.0034065 - 0.0004146j), vx_down=(-2.4014e-05 + 1.2492e-05j) * dip_kick,
                         vy_down=(3.6481e-05 + 7.9888e-06j) * dip_kick, vxx_down=(-0.004057 - 0.0001369j),
                         vxy_down=(0.0029243 - 1.2891e-05j), eid='C.A1.1.2.I1')
    c_a1_1_3_i1 = Cavity(l=1.0377, v=0.018125, freq=1300000000.0, vx_up=(-5.6813e-05 + 1.0751e-05j) * dip_kick,
                         vy_up=(-4.1091e-05 + 5.739e-07j) * dip_kick, vxx_up=(0.00099943 - 0.00081401j),
                         vxy_up=(0.0034065 - 0.0004146j), vx_down=(-2.4014e-05 + 1.2492e-05j) * dip_kick,
                         vy_down=(3.6481e-05 + 7.9888e-06j) * dip_kick, vxx_down=(-0.004057 - 0.0001369j),
                         vxy_down=(0.0029243 - 1.2891e-05j), eid='C.A1.1.3.I1')
    c_a1_1_4_i1 = Cavity(l=1.0377, v=0.018125, freq=1300000000.0, vx_up=(-5.6813e-05 + 1.0751e-05j) * dip_kick,
                         vy_up=(-4.1091e-05 + 5.739e-07j) * dip_kick, vxx_up=(0.00099943 - 0.00081401j),
                         vxy_up=(0.0034065 - 0.0004146j), vx_down=(-2.4014e-05 + 1.2492e-05j) * dip_kick,
                         vy_down=(3.6481e-05 + 7.9888e-06j) * dip_kick, vxx_down=(-0.004057 - 0.0001369j),
                         vxy_down=(0.0029243 - 1.2891e-05j), eid='C.A1.1.4.I1')
    c_a1_1_5_i1 = Cavity(l=1.0377, v=0.018125, freq=1300000000.0, vx_up=(-5.6813e-05 + 1.0751e-05j) * dip_kick,
                         vy_up=(-4.1091e-05 + 5.739e-07j) * dip_kick, vxx_up=(0.00099943 - 0.00081401j),
                         vxy_up=(0.0034065 - 0.0004146j), vx_down=(-2.4014e-05 + 1.2492e-05j) * dip_kick,
                         vy_down=(3.6481e-05 + 7.9888e-06j) * dip_kick, vxx_down=(-0.004057 - 0.0001369j),
                         vxy_down=(0.0029243 - 1.2891e-05j), eid='C.A1.1.5.I1')
    c_a1_1_6_i1 = Cavity(l=1.0377, v=0.018125, freq=1300000000.0, vx_up=(-5.6813e-05 + 1.0751e-05j) * dip_kick,
                         vy_up=(-4.1091e-05 + 5.739e-07j) * dip_kick, vxx_up=(0.00099943 - 0.00081401j),
                         vxy_up=(0.0034065 - 0.0004146j), vx_down=(-2.4014e-05 + 1.2492e-05j) * dip_kick,
                         vy_down=(3.6481e-05 + 7.9888e-06j) * dip_kick, vxx_down=(-0.004057 - 0.0001369j),
                         vxy_down=(0.0029243 - 1.2891e-05j), eid='C.A1.1.6.I1')
    c_a1_1_7_i1 = Cavity(l=1.0377, v=0.018125, freq=1300000000.0, vx_up=(-5.6813e-05 + 1.0751e-05j) * dip_kick,
                         vy_up=(-4.1091e-05 + 5.739e-07j) * dip_kick, vxx_up=(0.00099943 - 0.00081401j),
                         vxy_up=(0.0034065 - 0.0004146j), vx_down=(-2.4014e-05 + 1.2492e-05j) * dip_kick,
                         vy_down=(3.6481e-05 + 7.9888e-06j) * dip_kick, vxx_down=(-0.004057 - 0.0001369j),
                         vxy_down=(0.0029243 - 1.2891e-05j), eid='C.A1.1.7.I1')
    c_a1_1_8_i1 = Cavity(l=1.0377, v=0.018125, freq=1300000000.0, vx_up=(-5.6813e-05 + 1.0751e-05j) * dip_kick,
                         vy_up=(-4.1091e-05 + 5.739e-07j) * dip_kick, vxx_up=(0.00099943 - 0.00081401j),
                         vxy_up=(0.0034065 - 0.0004146j), vx_down=(-2.4014e-05 + 1.2492e-05j) * dip_kick,
                         vy_down=(3.6481e-05 + 7.9888e-06j) * dip_kick, vxx_down=(-0.004057 - 0.0001369j),
                         vxy_down=(0.0029243 - 1.2891e-05j), eid='C.A1.1.8.I1')

    c3_ah1_1_1_i1 = Cavity(l=0.346, v=0.0025, phi=180.0, freq=3900000000.0,
                           vx_up=dip_kick * (-0.00057076 - 1.3166e-05j), vy_up=dip_kick * (-3.5079e-05 + 0.00012636j),
                           vxx_up=(-0.026045 - 0.042918j), vxy_up=(0.0055553 - 0.023455j),
                           vx_down=dip_kick * (-8.8766e-05 - 0.00024852j),
                           vy_down=dip_kick * (2.9889e-05 + 0.00014486j), vxx_down=(-0.0050593 - 0.013491j),
                           vxy_down=(0.0051488 + 0.024771j), eid='C3.AH1.1.1.I1')
    c3_ah1_1_2_i1 = Cavity(l=0.346, v=0.0025, phi=180.0, freq=3900000000.0, vx_up=dip_kick * (0.00057076 + 1.3166e-05j),
                           vy_up=dip_kick * (3.5079e-05 - 0.00012636j), vxx_up=(-0.026045 - 0.042918j),
                           vxy_up=(0.0055553 - 0.023455j), vx_down=dip_kick * (8.8766e-05 + 0.00024852j),
                           vy_down=dip_kick * (-2.9889e-05 - 0.00014486j), vxx_down=(-0.0050593 - 0.013491j),
                           vxy_down=(0.0051488 + 0.024771j), eid='C3.AH1.1.2.I1')
    c3_ah1_1_3_i1 = Cavity(l=0.346, v=0.0025, phi=180.0, freq=3900000000.0,
                           vx_up=dip_kick * (-0.00057076 - 1.3166e-05j), vy_up=dip_kick * (-3.5079e-05 + 0.00012636j),
                           vxx_up=(-0.026045 - 0.042918j), vxy_up=(0.0055553 - 0.023455j),
                           vx_down=dip_kick * (-8.8766e-05 - 0.00024852j),
                           vy_down=dip_kick * (2.9889e-05 + 0.00014486j), vxx_down=(-0.0050593 - 0.013491j),
                           vxy_down=(0.0051488 + 0.024771j), eid='C3.AH1.1.3.I1')
    c3_ah1_1_4_i1 = Cavity(l=0.346, v=0.0025, phi=180.0, freq=3900000000.0, vx_up=dip_kick * (0.00057076 + 1.3166e-05j),
                           vy_up=dip_kick * (3.5079e-05 - 0.00012636j), vxx_up=(-0.026045 - 0.042918j),
                           vxy_up=(0.0055553 - 0.023455j), vx_down=dip_kick * (8.8766e-05 + 0.00024852j),
                           vy_down=dip_kick * (-2.9889e-05 - 0.00014486j), vxx_down=(-0.0050593 - 0.013491j),
                           vxy_down=(0.0051488 + 0.024771j), eid='C3.AH1.1.4.I1')
    c3_ah1_1_5_i1 = Cavity(l=0.346, v=0.0025, phi=180.0, freq=3900000000.0,
                           vx_up=dip_kick * (-0.00057076 - 1.3166e-05j), vy_up=dip_kick * (-3.5079e-05 + 0.00012636j),
                           vxx_up=(-0.026045 - 0.042918j), vxy_up=(0.0055553 - 0.023455j),
                           vx_down=dip_kick * (-8.8766e-05 - 0.00024852j),
                           vy_down=dip_kick * (2.9889e-05 + 0.00014486j), vxx_down=(-0.0050593 - 0.013491j),
                           vxy_down=(0.0051488 + 0.024771j), eid='C3.AH1.1.5.I1')
    c3_ah1_1_6_i1 = Cavity(l=0.346, v=0.0025, phi=180.0, freq=3900000000.0, vx_up=dip_kick * (0.00057076 + 1.3166e-05j),
                           vy_up=dip_kick * (3.5079e-05 - 0.00012636j), vxx_up=(-0.026045 - 0.042918j),
                           vxy_up=(0.0055553 - 0.023455j), vx_down=dip_kick * (8.8766e-05 + 0.00024852j),
                           vy_down=dip_kick * (-2.9889e-05 - 0.00014486j), vxx_down=(-0.0050593 - 0.013491j),
                           vxy_down=(0.0051488 + 0.024771j), eid='C3.AH1.1.6.I1')
    c3_ah1_1_7_i1 = Cavity(l=0.346, v=0.0025, phi=180.0, freq=3900000000.0,
                           vx_up=dip_kick * (-0.00057076 - 1.3166e-05j), vy_up=dip_kick * (-3.5079e-05 + 0.00012636j),
                           vxx_up=(-0.026045 - 0.042918j), vxy_up=(0.0055553 - 0.023455j),
                           vx_down=dip_kick * (-8.8766e-05 - 0.00024852j),
                           vy_down=dip_kick * (2.9889e-05 + 0.00014486j), vxx_down=(-0.0050593 - 0.013491j),
                           vxy_down=(0.0051488 + 0.024771j), eid='C3.AH1.1.7.I1')
    c3_ah1_1_8_i1 = Cavity(l=0.346, v=0.0025, phi=180.0, freq=3900000000.0, vx_up=dip_kick * (0.00057076 + 1.3166e-05j),
                           vy_up=dip_kick * (3.5079e-05 - 0.00012636j), vxx_up=(-0.026045 - 0.042918j),
                           vxy_up=(0.0055553 - 0.023455j), vx_down=dip_kick * (8.8766e-05 + 0.00024852j),
                           vy_down=dip_kick * (-2.9889e-05 - 0.00014486j), vxx_down=(-0.0050593 - 0.013491j),
                           vxy_down=(0.0051488 + 0.024771j), eid='C3.AH1.1.8.I1')
    ...
    # Lattice
    cell2 = (stsec_23_i1, d_1, solb_23_i1, qln_23_i1, qls_23_i1, d_2, ckx_23_i1, cky_23_i1, d_3,
