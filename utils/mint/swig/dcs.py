...
class BPM(_object):
    ...
    __swig_setmethods__["s_pos"] = _dcs.BPM_s_pos_set
    __swig_getmethods__["s_pos"] = _dcs.BPM_s_pos_get
    if _newclass:s_pos = _swig_property(_dcs.BPM_s_pos_get, _dcs.BPM_s_pos_set)
    def __init__(self, *args): 
